...
from omni.kit.viewport.utility import get_active_viewport_, capture_viewport_to_file
...
def run_simulator(sim: sim_utils.SimulationContext, entities: dict[str, Articulation], origins: torch.Tensor):
    ...
    while simulation_app.is_running():
        ...
        vp_api = get_active_viewport_()
        capture_viewport_to_file(vp_api, f"screenshot.png")
